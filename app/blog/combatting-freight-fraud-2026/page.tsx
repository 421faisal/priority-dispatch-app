                            ...
                            <div className="mt-16 rounded-2xl bg-card p-8 flex flex-col md:flex-row items-center gap-8 border border-border shadow-lg relative overflow-hidden">
                                ...
                                <div className="text-center md:text-left relative z-10">
                                    ...
                                    <p className="text-muted-foreground leading-relaxed text-sm md:text-base mb-4">
                                        <strong>Muhammad Faisal Bilal</strong> is the visionary CEO of Priority Dispatch LLC and a nationally recognized pioneer in logistical cybersecurity and freight anti-fraud initiatives. Relying on his profound Computer Science background, he has engineered proprietary operational firewalls that actively block thousands of malicious double-brokering attempts annually. His uncompromising vetting protocols have successfully recovered millions in stolen freight revenue for the independent motor carriers relying on his protection.
                                    </p>
                                    <a
