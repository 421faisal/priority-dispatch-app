                            ...
                            <div className="mt-16 rounded-2xl bg-card p-8 flex flex-col md:flex-row items-center gap-8 border border-border shadow-lg relative overflow-hidden">
                                ...
                                <div className="text-center md:text-left relative z-10">
                                    ...
                                    <p className="text-muted-foreground leading-relaxed text-sm md:text-base mb-4">
                                        <strong>Muhammad Faisal Bilal</strong> is the visionary founder and CEO of Priority Dispatch LLC. Backed by a strong Computer Science foundation from the University of Gujrat, he merges algorithmic data optimization with deep trucking industry expertise. Faisal is dedicated to empowering new owner-operators, designing proprietary logistics firewalls, and helping small carriers scale their fleets profitably from day one.
                                    </p>
                                    <a
                                        href="https://www.linkedin.com/in/muhammad-faisal-bilal"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="inline-flex items-center justify-center md:justify-start gap-2 text-white bg-accent hover:bg-accent/90 px-4 py-2 rounded-lg font-bold transition-all transform hover:scale-105"
                                    >
