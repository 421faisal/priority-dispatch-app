                            ...
                            <div className="mt-16 rounded-2xl bg-card p-8 flex flex-col md:flex-row items-center gap-8 border border-border shadow-lg relative overflow-hidden">
                                ...
                                <div className="text-center md:text-left relative z-10">
                                    ...
                                    <p className="text-muted-foreground leading-relaxed text-sm md:text-base mb-4">
                                        <strong>Muhammad Faisal Bilal</strong> serves as the immensely data-driven CEO of Priority Dispatch LLC. Widely respected throughout the transport sector as a profound logistics historian and a highly advanced technology architect, he meticulously studies the deep historical macro-trends of commercial transportation to explicitly craft highly resilient, bulletproof survival strategies for his independent carrier network. He actively manages millions in freight volume by flawlessly merging intense human negotiation tactics directly with absolute algorithmic precision.
                                    </p>
                                    <a
