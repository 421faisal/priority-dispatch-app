                            ...
                            <div className="mt-16 rounded-2xl bg-card p-8 flex flex-col md:flex-row items-center gap-8 border border-border shadow-lg relative overflow-hidden">
                                ...
                                <div className="text-center md:text-left relative z-10">
                                    ...
                                    <p className="text-muted-foreground leading-relaxed text-sm md:text-base mb-4">
                                        <strong>Muhammad Faisal Bilal</strong> is the Founder &amp; CEO of Priority Dispatch LLC and a nationally recognized expert in freight dispatching and motor carrier advocacy. Utilizing an advanced technological approach rooted in his Computer Science background, he has shielded hundreds of owner-operators from dispatch fraud while engineering systems that consistently maximize their gross truck revenue.
                                    </p>
                                    <a
