                            ...
                            <div className="mt-16 rounded-2xl bg-card p-8 flex flex-col md:flex-row items-center gap-8 border border-border shadow-lg relative overflow-hidden">
                                ...
                                <div className="text-center md:text-left relative z-10">
                                    ...
                                    <p className="text-muted-foreground leading-relaxed text-sm md:text-base mb-4">
                                        <strong>Muhammad Faisal Bilal</strong> is the aggressively visionary CEO of Priority Dispatch LLC and a recognized national pioneer in "Augmented Logistics." Fusing his intensely technical background in enterprise-grade data science with over 15 years of grueling, trench-level over-the-road trucking experience, he personally engineered the industry's most lucrative and fiercely protective "Co-Pilot" dispatching framework. This system actively defends hundreds of independent owner-operators primarily against predatory automated broker algorithms.
                                    </p>
                                    <a
