                            ...
                            <div className="mt-16 rounded-2xl bg-card p-8 flex flex-col md:flex-row items-center gap-8 border border-border shadow-lg relative overflow-hidden">
                                ...
                                <div className="text-center md:text-left relative z-10">
                                    ...
                                    <p className="text-muted-foreground leading-relaxed text-sm md:text-base mb-4">
                                        <strong>Muhammad Faisal Bilal</strong> is the dynamic Founder & CEO of Priority Dispatch LLC and a leading tactical architect in the North American cold-chain logistics sector. By blending his high-level Computer Science education with intensive freight market analysis, he developed the "Thermometric Routing Matrix," a proprietary dispatch system used to drastically reduce empty miles for temperature-controlled carriers. His profound advocacy for independent owner-operators has helped hundreds of small fleets secure exclusive, high-margin agricultural and pharmaceutical contracts usually reserved strictly for mega-corporations.
                                    </p>
                                    <a
