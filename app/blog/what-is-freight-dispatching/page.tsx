                            ...
                            <div className="mt-16 rounded-2xl bg-card p-8 flex flex-col md:flex-row items-center gap-8 border border-border shadow-lg relative overflow-hidden">
                                ...
                                <div className="text-center md:text-left relative z-10">
                                    ...
                                    <p className="text-muted-foreground leading-relaxed text-sm md:text-base mb-4">
                                        <strong>Muhammad Faisal Bilal</strong> is the Founder &amp; CEO of Priority Dispatch LLC. Armed with a BS in Computer Science and years of rigorous, hands-on experience in the volatile freight logistics market, he has personally overseen the implementation of high-yield dispatch strategies that have helped more than 100+ active motor carriers across all 48 states consistently push their revenue per mile to the top brackets of the industry.
                                    </p>
                                    <a
